...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $Fim_de_Tempo = time();
    $_SESSION['tempoFinalizado'] = $Fim_de_Tempo - $_SESSION['Tempo'];

    header("Location: resultadoFinal.php");
    exit;
}
...
<body class="corpo">
    ...
    <form action="quiz10.php" method="post">
        <div class="primeiraQST">
            <h2>até quantos blocos o sinal de redstone ativo consegue ir ?</h2><br>
