...
<body class="corpo">
    ...
    <form action="quiz.php" method="post">
        <div class="primeiraQST">
            <h2>Com quantas madeiras se faz <br>uma mesa de trabalho?</h2>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="qst1" value="4" id="RespostaCerta">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="qst1" value="6" id="RespostaErrada2">
                <label class="form-check-label" for="radioDefault3">
                    6
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="qst1" value="7" id="RespostaErrada3">
