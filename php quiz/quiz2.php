        ...
        <div class="primeiraQST">
            ...
            <div class="form-check">
                ...
                <label class="form-check-label" for="radioDefault4">
                    a abobora do minecraft não é uma abobora
                </label>
            </div>
        </div>
